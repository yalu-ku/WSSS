...
def get_arguments():
    ...
    parser.add_argument("--network", type=str, default='models.RepLKNet', help='wandb name')

    parser.add_argument("--img_dir", type=str, default='', help='Directory of training images')
    parser.add_argument("--train_list", type=str, default='/root/wsss_baseline2/metadata/voc12/train_aug_cls.txt')
    parser.add_argument("--test_list", type=str, default='/root/wsss_baseline2/metadata/voc12/train_cls.txt')
...
def get_model(args):
    ...
    if 'RepLKNet' in args.network:
        # model = getattr(importlib.import_module(args.network), 'RepLKNet')(pretrained=True)
        # model = RepLKNet(pretrained=True)
