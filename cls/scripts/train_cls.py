...
from models.origin_vgg import vgg16
...
def get_arguments():
    ...
    parser.add_argument("--test_list", type=str, default='/root/WSSS/metadata/voc12/ttrain_cls.txt')
    parser.add_argument('--save_folder', default='checkpoints/VGG16', help='Location to save checkpoint models')
